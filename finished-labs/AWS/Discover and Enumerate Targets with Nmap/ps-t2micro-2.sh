...
sudo http_proxy=http://tstark:pssecrocks@172.31.245.222:8888 apt -y install tomcat7
sudo http_proxy=http://tstark:pssecrocks@172.31.245.222:8888 systemctl start tomcat7